-- PRODUCTOS
INSERT INTO producto (id_producto, url, stock, categoria, nombre_producto, venta_producto) VALUES
(101, 'https://img.cards/pikachu-vmax', 5, 'Carta', 'Pikachu VMAX', 12),
(102, 'https://img.board/risk', 7, 'Juego de Mesa', 'Risk', 22),
(103, 'https://img.cards/mewtwo-shadow', 6, 'Carta', 'Mewtwo Sombra', 19),
(104, 'https://img.board/magic-maze', 6, 'Juego de Mesa', 'Magic Maze', 18),
(105, 'https://img.cards/black-lotus', 2, 'Carta', 'Black Lotus', 40),
(106, 'https://img.board/zombicide', 5, 'Juego de Mesa', 'Zombicide', 21),
(107, 'https://img.cards/sailor-moon', 8, 'Carta', 'Sailor Moon Rare', 8),
(108, 'https://img.board/monopoly-mario', 8, 'Juego de Mesa', 'Monopoly Mario Kart', 28),
(109, 'https://img.cards/darth-vader', 5, 'Carta', 'Darth Vader Especial', 12),
(110, 'https://img.board/trivial-pursuit', 9, 'Juego de Mesa', 'Trivial Pursuit Geek', 26);
...
-- BOLETAS
INSERT INTO boleta (n_boleta, metodo_pago, estado_pago, monto_pago, impuestos, num_transaccion, fecha_c, id_carro) VALUES
(501, 'Tarjeta', 'Aprobado', 0, 'IVA', '11111', '2025-01-03', 401),
(502, 'Transferencia', 'Rechazado', 0, 'IVA', '22222', '2025-01-04', 402),
(503, 'Efectivo', 'Aprobado', 0, 'IVA', '33333', '2025-01-06', 403),
(504, 'Tarjeta', 'Rechazadp', 0, 'IVA', '44444', '2025-01-09', 404),
(505, 'Criptomoneda', 'Aprobado', 0, 'IVA', '55555', '2025-01-11', 405);

-- VALORACIÓN
INSERT INTO valoracion (id_usuario, fecha_v, comentario, puntuacion, id_producto) VALUES
('cliente1@invenpo.com', '2025-01-05', 'Impresionante carta vintage.', 5, 101),
('cliente2@invenpo.com', '2025-01-07', 'Muy divertido para jugar en familia.', 4, 102);
